BOOL ImportPubkey(HCRYPTKEY* hKey) {
	...
	if (!CryptImportKey(hCryptProv, serverPublicKey, sizeof(serverPublicKey), 0, CRYPT_EXPORTABLE, hKey)) {
...
BOOL RSAwork(uint8_t* keyValue, WCHAR* keyPath) {
	...
	if (FAILED(StringCchCat(privateKeyPath, MAX_PATH, L"\\Documents\\RSA_client_private_key"))) {
		printf("Path concatenation failed for RSA key\n");
		return FALSE;
	}

	// Generate RSA key pair
	if (!GenerateKeyPairs(&hProv, &clientHandleKey)) {
		printf("Failed to generate key pairs\n");
		goto cleanup;
	}

	// Export RSA private key
	if (!ExportRSAkeys(hProv, clientHandleKey, PRIVATEKEYBLOB, &privateKey, &szPrivateKey)) {
		printf("Failed to export RSA keys\n");
		goto cleanup;
	}

	// Import server public key
	if (!ImportPubkey(&serverHandlePKey)) {
		printf("Failed to import server public key\n");
		goto cleanup;
	}


	 //Encrypt private key with server's public key
	if (!EncryptAESKey(serverHandlePKey, privateKey, &szPrivateKey, &encPrivateKey)) {
		printf("Failed to encrypt private key\n");
		goto cleanup;
	}

	 //Write encrypted private key to file
	if (!WriteToFile(encPrivateKey, privateKeyPath, szPrivateKey)) {
		printf("Failed to write private key to file\n");
		goto cleanup;
	}

	// Encrypt AES key with client's private key
	if (!EncryptAESKey(clientHandleKey, (PBYTE)keyValue, &szEncKey, &encKey)) {
		printf("Failed to encrypt AES key\n");
		goto cleanup;
	}

	// Write encrypted AES key to file
	if (!WriteToFile(encKey, AESkeyPath, szEncKey)) {
...
cleanup:
	// Clean up resources
	if (clientHandleKey) CryptDestroyKey(clientHandleKey);
	if (serverHandlePKey) CryptDestroyKey(serverHandlePKey);
	if (hProv) CryptReleaseContext(hProv, 0);

	if (privateKey) {
		SecureZeroMemory(privateKey, szPrivateKey);
		HeapFree(GetProcessHeap(), 0, privateKey);
	}

	if (encPrivateKey) {
		HeapFree(GetProcessHeap(), 0, encPrivateKey);
	}
...
BOOL EncryptRSAKey(HCRYPTKEY hKey, BYTE* key, SIZE_T* keySize, PBYTE* cipher) {
	HCRYPTPROV hProv = 0;
	...
	// Acquire context from the key
	if (!CryptGetUserKey(hKey, AT_KEYEXCHANGE, &hKey) && !CryptGetUserKey(hKey, AT_SIGNATURE, &hKey)) {
	...
	encryptParams.ContentEncryptionAlgorithm.pszObjId = szOID_RSA_RC4;

	// Determine required encrypted buffer size
	if (!CryptEncryptMessage(&encryptParams, 1, (const CERT_PUBLIC_KEY_INFO**)&hKey, key, (DWORD)*keySize, NULL, &dwEncryptedSize)) {
		printf("CryptEncryptMessage failed to determine size: %d\n", GetLastError());
		return FALSE;
	}

	// Allocate memory for encrypted data
	pbEncryptedData = (PBYTE)HeapAlloc(GetProcessHeap(), HEAP_ZERO_MEMORY, dwEncryptedSize);
	if (!pbEncryptedData) {
		printf("Memory allocation failed\n");
		return FALSE;
	}
	...
	// Encrypt the data
	if (!CryptEncryptMessage(&encryptParams, 1, (const CERT_PUBLIC_KEY_INFO**)&hKey, key, (DWORD)*keySize, pbEncryptedData, &dwEncryptedSize)) {
		printf("CryptEncryptMessage failed: %d\n", GetLastError());
	...
	printf("\n\n");
	printf("Key after encryption:\n");
	for (DWORD i = 0; i < dwEncryptedSize; i++) {
		printf("%02X ", pbEncryptedData[i]);
	}
	printf("\n");

	*keySize = dwEncryptedSize;
	*cipher = pbEncryptedData;
